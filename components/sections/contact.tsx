      ...
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-border/60 bg-background/90 p-4 shadow-sm">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground/60">Email</p>
            <Link
              href="mailto:yonnonline@gmail.com"
              className="mt-2 inline-block text-sm font-semibold text-foreground underline-offset-4 transition hover:underline"
            >
              yonnonline@gmail.com
            </Link>
          </div>
          <div className="rounded-2xl border border-border/60 bg-background/90 p-4 shadow-sm">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground/60">Phone</p>
            <Link
              href="tel:010-9317-8130"
              className="mt-2 inline-block text-sm font-semibold text-foreground underline-offset-4 transition hover:underline"
            >
              010-9317-8130
            </Link>
